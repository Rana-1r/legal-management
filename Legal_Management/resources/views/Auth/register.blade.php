...
<body class="min-h-screen flex items-center justify-center p-4 md:p-6 custom-bg overflow-x-hidden">
        ...
        <div class="bg-white/90 backdrop-blur-sm p-4 md:p-5 rounded-[28px] shadow-2xl w-full max-w-[360px] md:max-w-[420px]">
            ...
            <form action="{{ url('/register') }}" method="POST" class="space-y-2 text-right">
                ...
                <p class="text-center text-[11px] text-gray-500 mt-2">
                    لديك حساب بالفعل؟ <a href="{{ route('login') }}" class="text-blue-600 hover:underline font-semibold">سجل الدخول</a>
                </p>
            </form>
        </div>

        <div class="flex flex-col items-center justify-center text-center flex-1 md:mr-10 hidden md:flex">
